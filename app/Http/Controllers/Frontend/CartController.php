...
class CartController extends Controller
{
    ...
    public function getShippingFees($subtotal)
    {
    ...
    public function getAllTotals($cart_items, $promo_code)
    {
      ...
      $shipping_fees = $this->getShippingFees($subtotal);
    ...
    {
        SEO::setTitle('Everythink | Cart | Games, Toys and Entertainment online/offline store');
        ...
        SEO::setCanonical(getenv('APP_URL').'cart');
