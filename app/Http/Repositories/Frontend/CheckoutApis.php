...
class CheckoutApis {
    ...
    Insert an order
    ------------------------------------*/
    public function insertOrder($request, $cart_data, $shipping_fees, $promo_type, $promo_value, $subtotal, $total, $gift_check)
    {
        \DB::transaction(function () use ($request, $cart_data, $shipping_fees, $promo_type, $promo_value, $subtotal, $total, $gift_check)
        {  
    ...
    /*---------------------------------------
    Get the order payment method and payment branch from order_id
    -----------------------------------------*/
    public function getPaymentMethodFromId($order_id)
    {
        $q = \DB::select("SELECT payment_method, payment_branch
                         FROM orders
