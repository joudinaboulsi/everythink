...
<head>
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-0Y03DMLTDY"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'G-0Y03DMLTDY');
    </script>
...
<body>
    ...
    <a target="_blank" href="https://wa.me/{{config('global.WHATSAPP_NUMBER')}}" id="whatsapp-us" title="Whatsapp us now"> <img width="100%" src="/images/icons/whatsapp.png"/></a>
