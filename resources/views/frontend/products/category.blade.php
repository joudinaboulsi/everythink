                ...
                <ul class="brand-carousel owl-carousel owl-theme">
                    ...
                    <li>
                        <a class="mobile-cat" href="{{ route('product_list_path', $seo_link) }}">
                            <div class="cat-img"><img src="{{getenv('S3_URL')}}/categories/{{$h->img}}" alt="{{$h->name}}"></div>
                            <p>{{$h->name}}</p>
                        </a>
                    </li>
                    @endforeach
                    ...
                    <li>
                        <a class="mobile-cat" href="{{ route('product_of_collection_path', array($c->url_tag_name, $c->tag_id)) }}">
                ...
                <div class="col-lg-9 col-md-9 col-sm-12">
                    <div class="f-right">
                        <div class="w100  clearfix">
                            ...
                            <div class="show-hide visible-xs-inline"><img src="/images/icons/funnel.svg" class="img-responsive visible-xs-inline" width="20"> <strong>Filter</strong></div>
