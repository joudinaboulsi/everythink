{!! Form::open(array('route' => 'edit_user_information_path', 'class' => 'add-form', 'id' => 'edit_info_form', 'files' => true)) !!}
...
<div class="modal fade" id="modalResetPassword" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-md">
        ...
        <div class="modal-content">
          ...
          {!! Form::open(array('route' => 'edit_user_password_path', 'id' => 'pass_form')) !!}
