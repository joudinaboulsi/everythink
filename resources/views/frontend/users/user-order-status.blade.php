    ...
    <div class="row userInfo">
        ...
        <div class="statusContent">
            ...
            <div class="col-sm-12">
                <div class=" statusTop">
                    ...
                    @if($order_details[0]->gift)<p><strong>Wrap as gift:</strong> {{$order_details[0]->gift}} </p>@endif
       ...
       <!--      <div class="col-sm-6">
        ...
        <div class="col-xs-12 text-center">
            <a href="{{ route('user_account_path') }}" class="btn btn-stroke thin dark"> Back to My Account</a>
        </div>
