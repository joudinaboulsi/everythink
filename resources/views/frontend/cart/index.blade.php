                        ...
                        <tr class="CartProduct" id="rec_{{$i->cart_item_id}}"> 
                            ...
                            <td>
                                <div class="col-xs-10 no-padding">
                                    <div class="CartDescription">
                                        <h4 class="no-padding">
                                            <a href="{{route('product_details_path', $seo_link)}}">{{$i->product_name}} </a>
                                        </h4>
                                        <span class="size" style="color:#777">{{$i->attr_items}}</span>
                                ...
                                <div class="delete col-xs-2 no-padding text-right" style="vertical-align: top;">
                                    <a class="@if(Auth::check()) delete_item @else delete_item_offline @endif" id="{{$i->cart_item_id}}" title="Delete">
                                ...
                                <div class="col-xs-6 no-padding text-right">
                                    <div class="price">$ <span class="subtotals" id="subtotal_{{$i->variant_id}}">{{$i->current_price * $i->quantity}}</span></div>
                                </div>
                            </td>
                        </tr>
                ...
                <div class="w100 costDetails">
                    <div class="table-block" id="order-detail-content">
                        ...
                        <div class="text-center">
                            <a class="btn btn-stroke btn-dark checkout w100" title="checkout" href="{{route('checkout_path')}}"> Proceed to checkout </a>
                        </div>
...
{    
    ...
    $.ajax({
         ...
         success: function (data) {
            ...
            {               
                $('#qty_'+variant_id).attr('value', old_qty); // if error or out of stock, put back the old quantity value
                swal({
                    title: data.title,
                    text: data.msg,
                    type: "warning",
