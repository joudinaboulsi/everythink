	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-7 padd60">
				...
				<a href="/"> <img style="margin-bottom:20px;" src="images/logo.png" alt="Everythink" width="200"> </a>
		...
		@endif
				{!! Form::open(array('route' => 'pay_path', 'id' => 'pay_form', 'class' => 'add-form')) !!}
					...
					<div class="row">
						...
						<div class="col-sm-12">
							...
							<div class="panel panel-default">
							    <div class="panel-heading">
							    	<div class="radio">
									   	<label><input type="radio" name="payment_method" value="1"  @if(session('payment_method') == 1 || session('payment_method') == NULL) checked @endif>Payment via Whatsapp</label>
									</div>
							    </div>
							    <div class="panel-body all_payments_details payment_details_1">After you check out, we will check your order and we we will send you a link via Whatsapp through Zbooni app so you can make your payment. Once the payment is made, we deliver your goods.</div>
							</div>

							<!-- <div class="panel panel-default">
							    <div class="panel-heading">
							    	<div class="radio">
									  	<label><input type="radio" name="payment_method" value="3" @if(session('payment_method') == 3 ) checked  @endif>Payment via Credit Card on Delivery</label>
									</div>
							    </div>
							    <div class="panel-body all_payments_details payment_details_3" style="display:none;">
							    	The delivery third party will arrange to get your payment via Credit Card. You can select it now and pay later by Cash (no worries :) ).
							    </div>
							</div> -->
							...
							<div class="panel panel-default">
							    ...
							    <div class="panel-body all_payments_details payment_details_2" style="display:none;">
							    	If you select this option, please make sure you have your cash on once you get you get your goods.
							    </div>
							</div>
							...
							<div class="panel panel-default">
							    <div class="panel-heading">
							    	<div class="radio">
									  	<label><input type="radio" name="payment_method" value="4" @if(session('payment_method') == 4 ) checked  @endif>Pick up from Branch</label>
									</div>
							    </div>
							    <div class="panel-body all_payments_details payment_details_4" style="display:none;">
							    	Your order might take up to 48 hours to be available in your selected branch. It will be reserved for 10 days starting the check out date and you can pay by Cash or Credit Card.
							    	<div class="radio">
								    	<label><input type="radio" name="payment_branch" value="Araya, Main Road" @if(session('payment_branch') == 'Araya, Main Road' ) checked  @endif> Araya, Main Road </label>
								    </div>
					                <div class="radio">
					                    <label><input type="radio" name="payment_branch" value="Hazmieh, Beirut City Center L1" @if(session('payment_branch') == 'Hazmieh, Beirut City Center L1' ) checked  @endif> Hazmieh, Beirut City Center L1 </label>
					                </div>
					                <div class="radio">
					                    <label><input type="radio" name="payment_branch" value="Ashrafieh, ABC L1" @if(session('payment_branch') == 'Ashrafieh, ABC L1' ) checked  @endif>Ashrafieh, ABC L1 </label>
					                </div>
							    </div>
							</div>
					...
					<div class="row">
						...
						<div class="col-md-12">
						 	<h4> <input id="gift_check" type="checkbox" name="gift_check" value="1" @if(session('gift_check')) checked @endif> &nbsp
						 		 <label class="gift_check_label" for="gift_check">Wrap as a gift </label>
						 	</h4>	
						</div>
...
// black "complete order" button with ladda function when we click it
