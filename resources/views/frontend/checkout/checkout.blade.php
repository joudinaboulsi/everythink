	...
	<div class="container">
			...
			@endif
				...
				{!! Form::open(array('route' => 'save_shipping_address_delivery_path', 'id' => 'save_form', 'class' => 'add-form')) !!}
						...
						@if(Auth::check()) 	
						  	<div class="col-md-12 form-group user-input-wrp">
								<select name="stored_address_id" class="inputText form-control" id="stored_address" aria-describedby="basic-addon3">
									<option value="" disabled>Stored Addresses</option>
					  			...
					  			<label class="floating-label" for="stored_address">Stored Addresses</label>
							</div>
						@endif
					...
					<div class="row">
						...
						<div class="col-md-6 form-group user-input-wrp">
						  	<input type="text" name="company" class="inputText form-control" value="{{session('company')}}">
						...
						<div class="col-md-3 form-group user-input-wrp">
							<input type="text" name="apartment" class="inputText form-control" value="{{session('apartment')}}">
						  	<label class="floating-label" for="apartment">Apartment</label>
						</div>

						<div class="col-md-5 form-group user-input-wrp">
							<input type="text" name="city" value="{{session('city')}}" class="inputText form-control" required>
						  	<label class="floating-label" for="city">City </label>
						</div>

						<div class="col-md-4 form-group user-input-wrp">
							<input type="text" name="postal_code" value="{{session('postal_code')}}" class="inputText form-control">
						...
						<div class="col-md-12 form-group user-input-wrp">
							<select name="country" id="country" value="{{session('country')}}" class="inputText form-control" required>
								...
								@foreach($countries as $c)
				                    <option value="{{$c->country_id}}" <?php if($c->country_id == session('country')) echo 'selected'; ?> >{{$c->title}}</option>
				                @endforeach
							</select>
						...
						<div class="col-md-12 form-group user-input-wrp">
							<input type="tel" id="address_phone" name="address_phone" value="{{session('address_phone')}}" class="inputText form-control" required>
						  	<label class="floating-label-phone" for="address_phone">Phone <sup style="color:red">*</sup></label>
						</div>
					...
					<div class="row" id="billing_div">
						...
						<div class="col-md-3 form-group user-input-wrp">
							<input type="text" name="billing_apartment" class="inputText form-control" value="{{session('billing_apartment')}}">
						  	<label class="floating-label" for="billing_apartment">Apartment</label>
						</div>

						<div class="col-md-5 form-group user-input-wrp">
							<input type="text" name="billing_city" value="{{session('billing_city')}} required" class="inputText form-control">
						...
						<div class="col-md-4 form-group user-input-wrp">
							<input type="text" name="billing_postal_code" value="{{session('billing_postal_code')}}" class="inputText form-control">
						  	<label class="floating-label" for="billing_postal_code">Postal Code</label>
						</div>
						...
						<div class="col-md-12 form-group user-input-wrp">
							<input type="tel" id="billing_address_phone" name="billing_address_phone" value="{{session('billing_address_phone')}}" class="inputText form-control">
						  	<label class="floating-label-phone" for="billing_address_phone">Phone <sup style="color:red">*</sup></label>
						</div>
		...
		{{--
						<div class="col-md-6 form-group user-input-wrp date" data-provide="datepicker">
							<input type="text" name="delivery_date" class="inputText form-control" placeholder="Date" value="{{session('delivery_date')}}">
