          ...
          <div id="signupbox" class="mainbox col-md-12 col-sm-12">
            <div class="panel panel-info"> 
              <div class="panel-body">       
                ...
                <div class="form-group col-md-12">  
                  <div class="controls ">
                    <label for="image" class="control-label requiredField"> Upload Image <span class="text-danger">(600x600)</span><small> or a propotional ratio</small><br><small><i>Image associated to the category</i></small></label>
                    <div class="controls  ">
