...
--}}
      <div class="form-group required">
        <label class="font-normal">Wrap as gift:</label> {{ $order_details[0]->gift }}
      </div>
    </div>
    ...
    <div class="col-md-4">
      ...
      <div class="form-group required">
        <label class="font-normal">Apartment</label>
      ...
      <div class="form-group required">
        <label class="font-normal">Tracking code:</label> {{$order_details[0]->tracking_code}}
      </div>
      @endif 
    </div>
              ...
              <tbody>
                ...
                @foreach($order_items as $item)
                  <tr class="gradeX" id="{{$item->order_item_id}}">
                    <td><img src="{{getenv('S3_URL')}}/products/thumbs/{{$item->product_img}}" width="35" style="border-radius:10px; margin-right:5px; border:1px solid grey;"> {{$item->product_name}} @if($item->sku != NULL) - {{$item->sku}}  @endif </td>
                    <td>
