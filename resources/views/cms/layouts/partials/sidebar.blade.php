 ...
 <nav class="navbar-default navbar-static-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
            ...
            <li class="{{ ( ($url == 'cms-home') || ( $url == 'cms-about') || ($url == 'cms-blog') || ($url == 'cms-tutorials') || (strpos($url, 'news-details-')) !== false ) ? 'active' : '' }}">
                ...
                <ul class="nav nav-second-level collapse">
                    ...
                    <li class="{{ ( ($url == 'cms-blog') || (strpos($url, 'news-details-')) !== false ) ? 'active' : '' }} ">
