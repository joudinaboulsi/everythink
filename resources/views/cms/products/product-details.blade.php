                ...
                <tbody>
                  @foreach($main_attribute_items as $m) 
                    <tr class="gradeX" id="rec_main_attr_item_{{ $m->attribute_item_id }}">
                      <td>{{ $m->item_name }}</td>
                      <td><img width="50" src="{{getenv('S3_URL')}}/attribute_items/thumbs/{{ $m->img }}" style="border-radius:10px; margin-right:5px;"></td>
                      <td class="center">
            ...
            <table id="client_table" class="footable table table-striped table-hover toggle-arrow-tiny default footable-loaded variants_table" >
              ...
              @if($variantsList) 
                ...
                <tr class="gradeX" id="var_rec_{{ $v->variant_id }}">
                  ...
                  <td>
                    <?php // check if the variant has image. if no diplay an unkown image
                      if($v->item_img != NULL)
                        $img = getenv('S3_URL').'/attribute_items/thumbs/'.$v->item_img;
                      else
                        $img = 'images/icons/box_icon.png';
                     ?>
                    <img src="{{$img}}" width="50" style="border-radius:10px; margin-right:5px; float:left;">  <span style="position:relative; top:7px; left:5px;">{{$v->sku}} <br> <small> {{$v->item_name}} </small></span>
                  </td>
...
<div id="add_main_attribute" class="modal fade" role="dialog">
  <div class="modal-md modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Add Main Attribute <small>Add your main attribute with the related images</small></h4>
      </div>
              ...
              <div class="row"> 
                ...
                <div class="form-group col-md-12">
                 <label for="attr_items" class="control-label col-md-12 requiredField">Image<span class="red_star">* <small><i> recommended size</i></small> (1200 x 800) px</span> <br><small><i>Upload the item image</i></small></label>
                   <div class="col-md-12">
                    <input class="input-md" type="file" name="image" required/>
                  </div>   
                </div>
              </div>
            </div>
              ...
              <div class="row"> 
                ...
                <div class="form-group col-md-4">
                  ...
                  <div class="form-group col-md-3">
                    <label for="variant_weight" class="control-label requiredField">Weight <small>(Kg)</small></label>
                    <div class="controls">
                      <input class="input-md textinput textInput form-control" id="variant_weight" name="variant_weight" placeholder="Weight" type="text"/>
                    </div>
                  </div>
                  <div class="form-group col-md-3">
                    <div class="controls">
            ...
            <div class="panel-body">
              <div class="row"> 
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group col-md-3">
                    <label for="edit_variant_weight" class="control-label requiredField">Weight <small>(Kg)</small></label>
                    <div class="controls">
                      <input class="input-md textinput textInput form-control" id="edit_variant_weight" name="edit_variant_weight" placeholder="Weight" type="text"/>
                    </div>
                  </div>
                  <div class="form-group col-md-3">
                    <div class="controls">
