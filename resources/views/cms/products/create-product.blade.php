            ...
            <div>
              <div id="signupbox" class="mainbox"> 
                ...
                <div class="form-group required">
                  <label for="weight" class="font-normal">Weight<small>(Kg)</small></label>
                  <div class="input-group date col-md-12">
                    <input class="input-md textinput textInput form-control" id="weight" name="weight" placeholder="Weight" type="text"/>
                  </div>
                </div>
                <div class="form-group required">
