              ...
              <div class="panel-body"> 
                ...
                <div class="form-group col-md-12">  
                  <div class="controls ">
                    ...
                    <input class="input-md textinput textInput form-control" name="subtitle" placeholder="Slide Subtitle" style="margin-bottom: 10px" type="text"/>
                  </div>
                </div>
                <div class="form-group col-md-12">  
                  <div class="controls ">
                ...
                <div class="form-group col-md-12">
                  <div class="controls">
                    <label class="control-label"> Image <span class="red_star">* <small><i> recommended size</i></small> (1920 x 848) px</span> <br>
                      <small><i>Upload an image to your slide</i></small>
                    </label>
            ...
            <div class="panel panel-info"> 
              <div class="panel-body"> 
                ...
                <div class="form-group col-md-12">
                  <div class="controls">
                    <label class="control-label"> Image <span class="red_star"> * <small><i> recommended size</i></small> (1920 x 848) px</span> <br>
                      <small><i>Upload an image to your Separator</i></small>
                    </label>
                    <input class="input-md textinput textInput form-control" name="image" type="file" required/>
                  </div>
                </div>
            ...
            <div class="panel-body"> 
              ...
              <div class="form-group col-md-12">  
                <div class="controls ">
                  ...
                  <input class="input-md textinput textInput form-control" maxlength="30" name="e_title" placeholder="Title" style="margin-bottom: 10px" type="text"/>
                </div>
              </div>
              ...
              <div class="form-group col-md-12">  
                <div class="controls ">
                  ...
                  <input class="input-md textinput textInput form-control" maxlength="30" name="e_subtitle" placeholder="Subtitle" style="margin-bottom: 10px" type="text"/>
                </div>
              </div>
              ...
              <div class="form-group col-md-12">
                <div class="controls">
                  <label for="description" class="control-label"> Image<span class="red_star">* <small><i> recommended size</i></small> (1920 x 848) px</span> <br>
                    <small><i>Upload an image to your Slide/Separator</i></small>
                  </label>
